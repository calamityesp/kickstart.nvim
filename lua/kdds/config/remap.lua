...
keymap.set('n', '<leader>tl', '<cmd>tabn<CR>', {desc = 'Go to next tab'})                                 -- Move to next tab
keymap.set('n', '<leader>tr', '<cmd>tabp<CR>', {desc = 'Go to previous tab'})                             -- Go to previous tab
keymap.set('n', '<leader>tf', '<cmd>tabnew %<CR>', {desc = 'Open current bugger in new tab'})             --Open current buffer in new tab
